...
const Sidebar = async ({ user }: { user: any }) => {
    ...
    // const posts = allPosts.filter(post => post.userId === user?.userId);
            ...
            <div className='flex relative flex-col items-center'>
                ...
                <div className='border-b border-b-gray-300'>
                    <div className='p-2 mt-5 text-center'>
                        <h1 className='font-bold hover:underline cursor-pointer'>{user ? `${user?.firstName} ${user?.lastName}` : "Payal Kumari Mern Stack"}</h1>
